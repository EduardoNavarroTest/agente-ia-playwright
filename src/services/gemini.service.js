...
/** Fetch a la API de Gemini, se puede reemplazar por otro módelo o incluso utilizar modelos locales (oLllama, LMStudio) **/
...
2. Si quiere ejecutar un test, responde únicamente con el nombre exacto del test (ojo, no del archivo) (sin explicaciones).
...
/** Esta es la función para formatear el resultado del test a un lenguaje natural usando el modelo de IA */
